...
import net.neoremind.fountain.eventposition.LocalFileBinlogAndOffsetDisposeEventPosition;
import net.neoremind.fountain.eventposition.factory.BinlogAndOffsetSyncPointFactory;
import net.neoremind.fountain.producer.datasource.binlogdump.BinlogFileNamePositionDumpStrategy;
 ...
 * @author zhangxu
 */
public class SingleShardBinlogSyncerV51Test {

    private Logger logger = LoggerFactory.getLogger(SingleShardBinlogSyncerV51Test.class);
    ...
    public void testSavePosition() throws InterruptedException {
        ...
        BinlogSyncer syncer = BinlogSyncBuilder.newBuilder()
                ...
                .disposeEventPosition(
                        new LocalFileBinlogAndOffsetDisposeEventPosition("/Users/baidu/work/fountain-git/test"))
                .consumer(new EventConsumer() {
                    @Override
                    public void onEvent(ChangeDataSet changeDataSet) {
                        printTableData(changeDataSet);
    ...
    public void testZookeeperHASavePosition() throws InterruptedException {
        ...
        zkEventPosition.setZkRootPath("/fountain/eventposition/testha_");
        zkEventPosition.setZkClientProvider(zkClient);
        zkEventPosition.setSyncPointFactory(new BinlogAndOffsetSyncPointFactory());
