package net.neoremind.fountain.test.it.oracle.rowbased51.singletable.nontrx;
...
@ContextConfiguration(locations = {"classpath:oracle/rowbased51/fountain-config-nontrx.xml"})
